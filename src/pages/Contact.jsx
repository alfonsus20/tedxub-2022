  ...
  return (
    ...
    >
      ...
      <div className="pb-24 relative max-w-screen-2xl mx-auto">
        <img
          src={contactPhone}
          className="hidden lg:block absolute -bottom-28 left-20 w-56 z-0"
          alt="Phone"
        />
        <img
          src={contactPhone}
          className="hidden lg:block absolute -top-8 right-32 w-32 rotate-12 z-0"
          alt="Phone"
        />
        <div className="container m-auto z-10">
          ...
          <div className="flex flex-row flex-wrap justify-center items-center gap-5 mt-14">
            <a
              className="px-5 py-2 rounded-full bg-main-3 text-main-2 flex flex-row w-fit items-center justify-center gap-1 hover:bg-main-2 hover:text-main-3 duration-200"
              target="_blank"
            ...
            <a
              className="px-5 py-2 rounded-full bg-main-3 text-main-2 flex flex-row w-fit items-center justify-center gap-1 hover:bg-main-2 hover:text-main-3 duration-200"
              href="mailto:tedxbrawijaya@gmail.com"
            >
