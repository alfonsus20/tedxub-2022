    ...
    <div className="min-h-screen w-full bg-cover bg-no-repeat" style={{ backgroundImage: `url("${background}")` }}>
      ...
      <div className="container m-auto z-10">
        ...
        <div className="flex flex-row flex-wrap justify-center items-center gap-5 mt-14">
          <a className="px-5 py-2 rounded-full bg-main-3 flex flex-row w-fit items-center justify-center gap-1" target="_blank" href="https://instagram.com/tedxuniversitasbrawijaya">
          ...
          <a className="px-5 py-2 rounded-full bg-main-3 flex flex-row w-fit items-center justify-center gap-1" target="_blank" href="https://twitter.com/TEDxBrawijaya">
